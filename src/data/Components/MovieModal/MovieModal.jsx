...
import backdropNotAvailable from "src/assets/backdrop_not_available.webp";
...
const MovieModal = ({ show, onClose, movie }) => {
    ...
    const fetchVid = async () => {
      try {
        const videoDetails = await axios.get(
          `https://api.themoviedb.org/3/movie/${movie.id}/videos?${api}`
        );
  ...
  if (!movie) {
    // make sure the movie info has been updated
    return <p>Loading...</p>;
  }
  return (
          ...
          <div className="modal-body">
            ...
            <div className="overview">
              ...
              {movie.overview ? (
                ...
                <p className="overview-content">No outline available</p>
              )}
            </div>
